...
export const ACTIVATE_USER_FAILURE = "ACTIVATE_ACCOUNT_FAILURE";
export const ACTIVATE_USER_SUCCESS = "ACTIVATE_ACCOUNT_SUCCESS";
...
export type ActivateUserSuccessActionType = { type: typeof ACTIVATE_USER_SUCCESS, payload: string };
export type ActivateUserFailureActionType = { type: typeof ACTIVATE_USER_FAILURE, payload: string };
...
export type AuthActionTypes = LoginSuccessActionType | LoginFailureActionType | ShowLoaderActionType |
    RegisterSuccessActionType | RegisterFailureActionType | LogoutSuccessActionType | ActivateUserSuccessActionType |
    ActivateUserFailureActionType | ForgotPasswordSuccessActionType | ForgotPasswordFailureActionType |
