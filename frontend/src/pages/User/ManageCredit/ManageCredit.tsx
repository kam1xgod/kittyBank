...
import { fetchCreditInfo } from '../../../redux/thunks/credit-thunks';
import { IconProp } from '@fortawesome/fontawesome-svg-core';

const ManageCredit: FC<RouteComponentProps<{ id: string }>> = ({ match }) => {
    const dispatch = useDispatch();
    const creditData: Partial<Credit> = useSelector((state: AppStateType) => state.credit.credit);
    const loading: boolean = useSelector((state: AppStateType) => state.credit.loading);
