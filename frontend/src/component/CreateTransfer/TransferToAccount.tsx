...
export const TransferToAccount: FC<PropsType> = ({
  transferData,
  loading,
  error,
}) => {
        ...
        <div className='row'>
          <div className='col-lg-6'>
              ...
              <div className='col-sm-5'>
                ...
                >
                  ...
                  {userAccountsData.map((account) => {
                    return (
                      <option className='form-control' value={account.number}>{account.number} - {account.balance} {account.currency.symbol}</option>
                    )
                  })}
                </select>
              </div>
            ...
            <button
              ...
              disabled={amount ? recipientNumber ? false : true : true }  
            >
              Validate transfer
            </button>
          </div>
