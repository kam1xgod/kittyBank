...
} from "../../../redux/thunks/account-thunks";
import {InitialStateType} from "../../../redux/reducers/account-reducer";
...
describe("perfume actions", () => {
    ...
    //     let expectedActions = [loadingPerfume(), fetchAccountSuccess(perfumeData)];
    //     expect(store.getActions()).toEqual(expectedActions);
    // });
    ...
    //     let expectedActions = [loadingPerfume(), fetchUserAccountsSuccess(perfumesData)];
    //     expect(store.getActions()).toEqual(expectedActions);
    // });
    ...
    //     let expectedActions = [loadingPerfume(), accountAddedSuccess(perfumesData)];
    //     expect(store.getActions()).toEqual(expectedActions);
    // });
    ...
    //     let expectedActions = [loadingPerfume(), accountAddedFailure(perfumesData)];
    //     expect(store.getActions()).toEqual(expectedActions);
    // });
